...
from utils.tf_utils.basemodel import mobilenet_v1
...
class Network(object):
    ...
    def inference(self, mode, inputs):
        ...
        with slim.arg_scope(mobilenet_v1_arg_scope()):
            net, end_points = mobilenet_v1.mobilenet_v1_base(image, scope='MobilenetV1')
        ...
        with tf.variable_scope(
            ...
            # rpn
            rpn = slim.conv2d(
                end_points['Conv2d_8_pointwise'], 256, [3, 3], trainable=is_training,
        ...
        with tf.variable_scope(
            ...
            ps_fm = rfcn_plus_plus_opr.global_context_module(
                 end_points['Conv2d_11_pointwise'], prefix='conv_new_1',
    ...
    def get_test_collection(self):
        ...
        ret['roi_scores'] = tf.get_collection('roi_scores')[0]
        return ret
